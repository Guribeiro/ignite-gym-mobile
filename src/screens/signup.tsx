...
export const Signup = () => {
  const {goBack} = useNavigation<AuthenticationNavigatorProps>()

  const {control, handleSubmit} = useForm<SignupFormData>({
    resolver: zodResolver(signupSchema)
  })

  const onSubmit = ({name, email, password, password_confirm}:SignupFormData) => {
        ...
        <VStack flex={1} px='$4' pb='$16'>
          ...
          <Center gap='$2'>
           ...
           <Controller 
            ...
            />
            <Button title='Acessar' mt='$4' onPress={handleSubmit(onSubmit)} />
          </Center>
